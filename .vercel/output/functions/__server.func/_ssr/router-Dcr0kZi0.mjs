...
//#region node_modules/.nitro/vite/services/ssr/assets/router-Dcr0kZi0.js
...
var styles_default = "/assets/styles-BJ2uG2Ka.css";
var APP_NAME = "TwitchBadges Live Tracker";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Live Overlay für aktive, endende und kommende Twitch-Badges."
			}
		],
		links: [
			{
...
var getBadgeFeed = createServerFn({ method: "GET" }).handler(createSsrRpc("97c600b8e72543d70258b04d08eb6eca8a7260e5737f7f3fae8ccaaf1fe5f86d"));
var $$splitComponentImporter = () => import("./routes-DoQUyeYK.mjs");
var Route = createFileRoute("/")({
	validateSearch: (s) => ({
		channel: typeof s.channel === "string" ? s.channel : void 0,
		interval: typeof s.interval === "string" || typeof s.interval === "number" ? Number(s.interval) : void 0
	}),
	loader: () => getBadgeFeed(),
...
//#endregion
export { Route as n, getBadgeFeed as r, router_exports as t };
