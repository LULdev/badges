...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-B1ycrXts.mjs");
...
var manifest = { "97c600b8e72543d70258b04d08eb6eca8a7260e5737f7f3fae8ccaaf1fe5f86d": {
	functionName: "getBadgeFeed_createServerFn_handler",
	importer: () => import("./badge-feed-8Ys_p0VP.mjs")
} };
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Dcr0kZi0.mjs").then((n) => n.t),
